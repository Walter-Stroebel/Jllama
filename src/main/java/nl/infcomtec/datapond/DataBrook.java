 ...
 * @author walter
 */
public class DataBrook extends TreeMap<DataDrop, DataDrop> {
    ...
    public final synchronized void save() {
        for (DataDrop dd : keySet()) {
            try {
                ...
                Logger.getLogger(DataBrook.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
